...
<article className={styles.card}><div className={styles.eyebrow}>↩ REVERSE PITCH™</div><h2>Tell us what you cover.</h2><p>The Media Floor finds the most relevant Bot Stores story instead of spraying every announcement at every reporter.</p><Link className={styles.button} href="/press/pitch">Find my angle</Link></article>
...
<article className={styles.card}><div className={styles.eyebrow}>CONTROL ROOM™</div><h2>What is getting attention?</h2><p>Aggregate alpha signals for headlines, interviews, reverse pitches and pass requests—without exposing reporter contact details.</p><Link className={styles.button} href="/press/control">Open alpha control room</Link></article>
</section>
