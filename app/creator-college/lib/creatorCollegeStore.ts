export type UnifiedCreation={
 id:string; title:string; kind:"digital_product"|"video_series"|"event_kit"|"service_offer"|"brand"; format:string; progress:number;
...
export function readUnifiedCreations():UnifiedCreation[]{
 ...
 return [...digital,...video,...events,...services,...brands].sort((a,b)=>String(b.updatedAt).localeCompare(String(a.updatedAt)));
}
